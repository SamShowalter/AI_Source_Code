...
class Markov_Network():
	...
	def clean_corpus(self, regex_string = " +"):
		"""
...
if __name__ == '__main__':
	...
	#test = Markov_Network("C:\\Users\\sshowalter\\Desktop\\ExcludeFromBackup\\Repos\\Recurrent_Story_Telling\\data\\catch22")
	test.clean_corpus()
	test.make_markov_network()
	test.make_cum_sum_network()
	#print(test.prob_network)
	test.write_prob_story(100)
	print(test.story)
